...
class PointNetfeat(nn.Module):
    def __init__(self, global_feat = True, feature_transform = False, point_dim=3):
        super(PointNetfeat, self).__init__()
        self.stn = STNkd(k=point_dim)
...
class PointNetDenseCls(nn.Module):
    def __init__(self, k=2, feature_transform=False, point_dim=3):
        ...
        self.k = k
        self.feature_transform=feature_transform
        self.feat = PointNetfeat(global_feat=False, feature_transform=feature_transform, point_dim=point_dim)
